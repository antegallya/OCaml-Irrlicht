...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1c57d49d46e5f8ed17ecd6242cefe4a3) *)
(*
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Alexis Bernadet < alexis.bernadet@noos.fr >"];
          homepage = None;
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for OCaml Irrlicht";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                      doc_build_tools =
                        [
                           ...
                           InternalExecutable "make_hash_values";
                           InternalExecutable "make_enums";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lIrrlicht"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])];
