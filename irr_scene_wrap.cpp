...
extern "C" CAMLprim value ml_SMeshBuffer_set_indices_used(
		value v_mb, value v_n)
{
	((SMeshBuffer*) v_mb)->Indices.set_used(Int_val(v_n));
	return Val_unit;
}
...
extern "C" CAMLprim value ml_IMesh_getMeshBufferCount(value v_mesh) {
